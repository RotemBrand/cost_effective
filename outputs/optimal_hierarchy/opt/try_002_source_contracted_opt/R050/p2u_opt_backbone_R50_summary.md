...
- Status: `OPT_CONSTRUCTED`
- Requested R: `50`
- Physical OPT R: `36`
- Achieved physical R: `36`
- Nodes/edges: `5310` / `5345`
- Sources/transformers: `15` / `5295`
- 2-edge-connected: `True`
- Tie edges: `36`
- Euclidean backbone length: `550499.277` m
- Mean/max edge length: `102.993` m / `2549.705` m
- Runtime: `42.40` s
