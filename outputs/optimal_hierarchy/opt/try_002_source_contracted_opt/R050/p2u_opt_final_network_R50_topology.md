...
- Final graph nodes/edges: `11842` / `11877`
- Source-contracted nodes/edges: `11828` / `11877`
...
- Backbone length: `550499.277` m
- Tree physical road-union length: `216849.203` m
- Total physical length: `767348.480` m
...
- Fitted failure rate per meter: `7.7389871e-06`
