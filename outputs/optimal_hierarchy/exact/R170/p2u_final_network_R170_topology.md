...
- Final graph nodes/edges: `10534` / `10689`
- Source-contracted nodes/edges: `10520` / `10689`
- Source-contracted cycle rank R: `170`
...
- Backbone length: `400429.124` m
- Tree physical road-union length: `188359.007` m
- Total physical length: `588788.132` m
...
- Fitted failure rate per meter: `9.0771191e-06`
