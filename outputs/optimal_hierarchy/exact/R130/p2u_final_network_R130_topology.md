...
- Final graph nodes/edges: `10516` / `10631`
- Source-contracted nodes/edges: `10502` / `10631`
- Source-contracted cycle rank R: `130`
...
- Backbone length: `401921.109` m
- Tree physical road-union length: `187749.290` m
- Total physical length: `589670.399` m
...
- Fitted failure rate per meter: `9.0143579e-06`
